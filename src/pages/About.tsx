...
export default function About() {
  return (
    <>
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              <Typography variant="body1" sx={{ color: palette.text.secondary, mb: 2, lineHeight: 1.8 }}>
                Corrado's Restaurant and Bar has been a cornerstone of the Whitby dining scene since
                2010. What started as a family dream — to bring the authentic flavours of Italy to
                our neighbourhood — has grown into one of the area's most beloved restaurants.
              </Typography>
              <Typography variant="body1" sx={{ color: palette.text.secondary, mb: 2, lineHeight: 1.8 }}>
                Our kitchen is rooted in tradition. Every sauce is simmered slowly, every pasta dish
                is crafted with care, and every pizza is stretched by hand and baked to perfection.
                We source the freshest ingredients to deliver flavours that remind you of an Italian
                grandmother's kitchen — warm, generous, and full of love.
              </Typography>
              <Typography variant="body1" sx={{ color: palette.text.secondary, mb: 3, lineHeight: 1.8 }}>
                But Corrado's is more than great food. It's a place where families gather, friends
                reconnect, sports fans cheer, and community bonds are strengthened. Whether you're
                here for a casual lunch, a romantic dinner for two, a family celebration, or just to
                watch the game — you'll feel right at home.
              </Typography>
              <Button
                variant="contained"
                color="primary"
            ...
            {[
              ...
              <Grid key={i} size={{ xs: 12, sm: 6 }}>
                <Card sx={{ height: '100%', p: 1 }}>
                  <CardContent>
                    <Box sx={{ color: palette.primary.main, mb: 2 }}>{item.icon}</Box>
      ...
      {/* Quick Facts */}
      <Box sx={{ py: { xs: 6, md: 8 }, bgcolor: palette.charcoal, color: '#fff' }}>
        <Container>
          ...
          <Grid container spacing={6} alignItems="center">
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              <Stack spacing={1.5} sx={{ mb: 3 }}>
                ...
                <Typography variant="body1" sx={{ color: palette.text.secondary }}>
                  <strong>Cuisine:</strong> Italian, Pasta, Pizza, Wings, Canadian
                </Typography>
                <Typography variant="body1" sx={{ color: palette.text.secondary }}>
                  <strong>Price Range:</strong> Moderate ($10 – $20)
                </Typography>
                <Typography variant="body1" sx={{ color: palette.text.secondary }}>
                  <strong>Payments:</strong> Visa, MasterCard, American Express, Interac
                </Typography>
              </Stack>
